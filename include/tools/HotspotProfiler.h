...
enum class HotspotId {
    ...
    PcfrCollectStatics,
    PcfrActionUtility,
    PcfrActionOpponentReach,
    PcfrActionOpponentChild,
    PcfrActionOpponentPayoff,
    PcfrActionPlayerChildren,
    PcfrActionPlayerPayoff,
    PcfrActionPlayerRegret,
    PcfrActionCollectEvs,
    PcfrChanceUtility,
    PcfrShowdownUtility,
    PcfrTerminalUtility,
...
private:
    ...
    static const char** names() {
        static const char* data[static_cast<int>(HotspotId::Count)] = {
            ...
            "pcfr.action_utility",
            "pcfr.action.opponent_reach",
            "pcfr.action.opponent_child",
            "pcfr.action.opponent_payoff",
            "pcfr.action.player_children",
            "pcfr.action.player_payoff",
            "pcfr.action.player_regret",
            "pcfr.action.collect_evs",
            "pcfr.chance_utility",
